...
class CreateShopsTable extends Migration
{
    public function up(): void
    {
        Schema::table(Util::getShopsTable(), function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('plan_id')->nullable(); // Use unsignedBigInteger for ID compatibility
            ...
            // Remove the foreign key constraint for SingleStore compatibility
    ...
    {
        Schema::table(Util::getShopsTable(), function (Blueprint $table) {
            // Do not drop foreign key constraint as it does not exist in SingleStore
